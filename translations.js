...
const translations = {
    ar: {
        ...
        deviceBadge2: "المستوى المتوسط (الموصى به للطلاب)",
        deviceTitle2: "الحواسيب المتقدمة للطلاب والمهندسين",
        deviceDesc2: "أداء متميز لنمذجة البيانات ثلاثية الأبعاد وعمل التحليلات الجغرافية المعقدة",
        ...
        entryCpu: "Intel Core Ultra 5 / AMD Ryzen 5 (جيل حديث)",
        entryRam: "16 GB DDR5 (الحد الأدنى لـ GIS في 2026)",
        entryGpu: "Intel Iris Xe / AMD Radeon Graphics",
        entryStorage: "512 GB NVMe M.2 SSD",
        entryList: "Lenovo IdeaPad Slim 3, ASUS VivoBook 15",
        
        midCpu: "Intel Core Ultra 7 / AMD Ryzen 7",
        midRam: "32 GB DDR5 (لأداء سلس ومستقر)",
        midGpu: "NVIDIA RTX 4050 / RTX 4060 (6GB VRAM)",
        midStorage: "1 TB PCIe Gen4 NVMe SSD",
        midList: "ASUS ROG Zephyrus G14, Lenovo Legion Pro 5",
        ...
        pcCpu: "AMD Ryzen 9 9900X / Intel Core Ultra 9 285K",
        pcRam: "64 GB DDR5 6400MHz (Dual Channel 2x32GB)",
        ...
        dataHubTitle: "مستودع البيانات الجغرافية السعودية المفتوحة",
        dataHubSubtitle: "دليلك السريع للوصول إلى مستودعات البيانات الجغرافية الرسمية والمفتوحة للمملكة العربية السعودية المعتمدة لمشاريع التخرج والتحليلات البيئية",
        ...
        // Geospatial Ethics Pledge & Certificate
        pledgeBadge: "الميثاق الجيومكاني والعهد الأخلاقي",
        pledgeTitle: "ميثاق الشرف الأخلاقي للبيانات الجغرافية",
        pledgeSubtitle: "لأن البيانات المكانية جزء لا يتجزأ من الأمن الوطني والتنمية المستدامة، نلتزم بحمايتها واستخدامها بمسؤولية وأمانة علمية.",
        pledgeInputNameLabel: "الاسم الثلاثي الكامل للباحث/الطالب:",
        pledgeInputPlaceholder: "اكتب اسمك الثلاثي الكامل هنا لتوثيق العهد...",
        pledgeCheck1: "ألتزم بالمحافظة الكاملة على خصوصية وسرية وأمن البيانات الجغرافية والخرائط التي تقع تحت يدي ولا أشاركها مع أي جهات غير مخولة.",
        pledgeCheck2: "أتعهد بعدم استخدام مهارات ونظم المعلومات الجغرافية إلا في تحقيق منافع التنمية وإعمار الأرض، والامتناع التام عن أي ضرر بيئي أو تضليل مكاني.",
        pledgeCheck3: "أقسم على احترام الأمانة العلمية وحقوق الملكية الفكرية للمصادر الوطنية، ونسب الفضل في جمع وتطوير البيانات الجغرافية لأصحابها ومؤسساتها.",
        pledgeBtnSign: "توقيع الميثاق وإصدار وثيقة العهد الأخلاقي",
        
        certTitle: "وثيقة العهد الأخلاقي والالتزام الجيومكاني",
        certPreface: "نشهد بكل فخر واعتزاز بأن الباحث الجيومكاني الواعد:",
        certSignatureTitle: "المشرف العام على المنصة",
        certSubtitle: "المنصة الجغرافية التعليمية السعودية",
        certBodyText: "تُمنح هذه الوثيقة تقديراً للباحث وتوثيقاً لالتزامه التام ببنود ميثاق الشرف للبيانات الجغرافية الوطنية، متعهداً بالعمل بمسؤولية مهنية وأمانة علمية لبناء مستقبل جيومكاني واعد للوطن.",
        certSerialLabel: "الرقم التسلسلي:",
        certDateLabel: "تاريخ التوقيع:",
        btnPrintCert: "طباعة وثيقة العهد",
        btnCloseCertText: "إغلاق وثيقة العهد",

        // Validation alerts & UI messages
        alertPledgeCheckAll: "✗ يرجى تحديد وقراءة جميع بنود الميثاق الأخلاقي الثلاثة للتعهد والالتزام بأمن البيانات الوطنية الجغرافية!",
        alertPledgeNameEmpty: "✗ يرجى كتابة اسمك الثلاثي بالكامل لتوقيع الميثاق وإصدار وثيقة العهد الأخلاقي الجيومكاني!",
        alertShpZipOnly: "الرجاء رفع ملف Shapefile مضغوط بصيغة .zip حصراً!",
        alertShpjsUnavailable: "مكتبة Shp.js غير متوفرة حالياً، تأكد من الاتصال بالإنترنت!",
        alertShpReadFailed: "فشل في قراءة ملف Shapefile المضغوط! تأكد من وجود ملفي .shp و .dbf بداخل مجلد الـ zip.",
        alertCsvEmpty: "ملف CSV فارغ أو لا يحتوي على صفوف صالحة!",
        alertCsvCoordsNotFound: "فشل في التعرف على أعمدة خط الطول أو العرض! يرجى التأكد من تسمية الأعمدة كـ Latitude و Longitude.",
        alertCsvNoValidCoords: "لا توجد إحداثيات مكانية صالحة أو مطابقة داخل أعمدة الـ CSV!",
        alertGeojsonInvalid: "ملف GeoJSON غير صالح أو ليس FeatureCollection قياسي!",
        alertGeojsonNoFeatures: "ملف GeoJSON لا يحتوي على أي معالم مكانية!",
        alertGeojsonCorrupt: "ملف GeoJSON معطوب أو غير صالح للتفكيك!",
        alertNewsDraftSuccess: "✓ تم إرسال مسودة الخبر بنجاح! \nعنوان الخبر: \"{TITLE}\" \nسيتم مراجعة الخبر وتدقيقه مساحياً ونشره تحت إشراف Yazeed Alshammari في شريط الأخبار قريباً.",

        // Converter progress bar status texts
        noFileProcessed: "لا يوجد ملف معالج حالياً",
        progressReading: "جاري قراءة بنية الملف محلياً...",
        progressDecompressing: "جاري إلغاء ضغط وفك ملفات Shapefile...",
        progressGenerating: "جاري توليد ملف GeoJSON مساحي...",
        progressShpDone: "اكتمل التحويل المساحي بنجاح!",
        progressAnalyzing: "جاري تحليل أعمدة البيانات الجغرافية...",
        progressProjecting: "جاري إسقاط النقاط وربط البيانات الجدولية...",
        progressCsvDone: "اكتمل تحويل ملف CSV بنجاح!",
        progressParsing: "جاري تفكيك مصفوفات GeoJSON...",
        progressBuilding: "جاري بناء جدول البيانات الوصفية...",
        progressGeojsonDone: "اكتمل التحويل الجدولي بنجاح!"
    },
    ...
    en: {
        ...
        // Geospatial Ethics Pledge & Certificate
        pledgeBadge: "Geospatial Covenant & Ethical Pledge",
        pledgeTitle: "Honorary Code of Ethics for Geographical Data",
        pledgeSubtitle: "Because spatial data is an integral part of national security and sustainable development, we pledge to protect it and use it with utmost responsibility and scientific integrity.",
        pledgeInputNameLabel: "Researcher/Student Full Name (Triple Name):",
        pledgeInputPlaceholder: "Type your full triple name here to seal the pledge...",
        pledgeCheck1: "I pledge to fully maintain the privacy, confidentiality, and security of geographic data and maps under my control, and never share them with unauthorized entities.",
        pledgeCheck2: "I covenant to employ GIS skills and systems solely for development and sustainable progress, avoiding any spatial misrepresentation or environmental harm.",
        pledgeCheck3: "I swear to respect scientific integrity and intellectual property of national sources, crediting original developers and authorities for spatial datasets.",
        pledgeBtnSign: "Sign Code of Ethics & Issue Spatial Covenant",
        
        certTitle: "Spatial Covenant & Ethical Pledge Certificate",
        certPreface: "We proudly certify that the promising geospatial researcher:",
        certSignatureTitle: "Platform General Supervisor",
        certSubtitle: "Saudi Educational Geospatial Platform",
        certBodyText: "This document is presented in recognition of the researcher's absolute commitment to the Honorary Code of Ethics for National Geographical Data, pledging to work with utmost professional responsibility and scientific integrity to build a promising geospatial future.",
        certSerialLabel: "Serial ID:",
        certDateLabel: "Date Signed:",
        btnPrintCert: "Print Spatial Covenant",
        btnCloseCertText: "Close Spatial Covenant",

        // Validation alerts & UI messages
        alertPledgeCheckAll: "✗ Please review and check all three ethical covenant terms to pledge your commitment to national geospatial data security!",
        alertPledgeNameEmpty: "✗ Please enter your full triple name to sign the covenant and issue your geospatial honor certificate!",
        alertShpZipOnly: "Please upload a compressed Shapefile in .zip format only!",
        alertShpjsUnavailable: "Shp.js library is not available, check your internet connection!",
        alertShpReadFailed: "Failed to read the compressed Shapefile! Ensure .shp and .dbf files exist inside the ZIP folder.",
        alertCsvEmpty: "CSV file is empty or does not contain valid rows!",
        alertCsvCoordsNotFound: "Failed to detect Latitude or Longitude columns! Please ensure your columns are named Latitude and Longitude.",
        alertCsvNoValidCoords: "No valid spatial coordinates found in the CSV columns!",
        alertGeojsonInvalid: "Invalid GeoJSON file or it is not a standard FeatureCollection!",
        alertGeojsonNoFeatures: "GeoJSON file does not contain any spatial features!",
        alertGeojsonCorrupt: "GeoJSON file is corrupt or invalid for processing!",
        alertNewsDraftSuccess: "✓ News draft submitted successfully!\nTitle: \"{TITLE}\"\nThe news will be reviewed, spatially audited, and published under Yazeed Alshammari's supervision in the ticker soon.",

        // Converter progress bar status texts
        noFileProcessed: "No file processed currently",
        progressReading: "Reading file structure locally...",
        progressDecompressing: "Decompressing Shapefile archive...",
        progressGenerating: "Generating spatial GeoJSON file...",
        progressShpDone: "Shapefile conversion completed successfully!",
        progressAnalyzing: "Analyzing geographic data columns...",
        progressProjecting: "Projecting points and linking tabular data...",
        progressCsvDone: "CSV file conversion completed successfully!",
        progressParsing: "Parsing GeoJSON arrays...",
        progressBuilding: "Building attribute data table...",
        progressGeojsonDone: "Tabular conversion completed successfully!"
    }
};
